...
run_vmp_fpca <- function(time_obs, Y, K, L,
  ...
  if (format_univ) {
    ...
    fpc_orthgn(subj_names, L, K, eta_in, time_g, C_g, Psi_g = Psi_g) # <---- K redefined inside - argument instead?
    ...
    mfpc_orthgn(subj_names, var_names, L, K, eta_in, time_g, N_sample, C_g, Psi_g)
