...
The two main functions to performance univariate and multivariate FPCA inference
are
`run_mfvb_fpca()` for mean-field variational Bayes and `run_vmp_fpca()` for
variational message passing algorithms. 
